...
(Thm 48.11) Let {\sigma_{i} | i \in I} be a collection of automorphisms of a field E. Then the set E_{{ \sigma_{i} }} of all a \in E left fixed by every \sigma_{i} for i \in I forms a subfield of E.

(Def 48.12) The field E_{{ \sigma_{i} }} of (Thm 48.11) is the fixed field of {\sigma_{i} | i \in I } . For a single automorphism \sigma, we shall refer to E_{ {\sigma } } as the fixed field of \sigma.
